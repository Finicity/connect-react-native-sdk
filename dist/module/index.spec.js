...
describe('FinicityConnect', () => {
  ...
  test('close', () => {
    const instanceOf = renderer.create( /*#__PURE__*/React.createElement(FinicityConnect, {
  ...
  test('render', () => {
    ...
    Platform.OS = 'android';
    let testRenderer = renderer.create( /*#__PURE__*/React.createElement(FinicityConnect, {
      connectUrl: "https://finicity.com",
      eventHandlers: eventHandlerFns,
      linkingUri: ""
    }));
    ...
    Platform.OS = 'ios';
    testRenderer = renderer.create( /*#__PURE__*/React.createElement(FinicityConnect, {
      connectUrl: "https://finicity.com",
      eventHandlers: eventHandlerFns,
      linkingUri: ""
    }));
  ...
  test('openBrowser/dismissBrowser', async () => {
    ...
    jest.spyOn(InAppBrowser, 'isAvailable').mockReturnValue(Promise.resolve(true));
    const spyOpenAuth = jest.spyOn(InAppBrowser, 'openAuth').mockImplementation(() => Promise.resolve({
      type: 'cancel'
    }));
    const spyCloseAuth = jest.spyOn(InAppBrowser, 'closeAuth').mockImplementation(jest.fn()); // Open Browser, and from above mock cancel
